<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200">
    ...
    <g fill="none">
      ...
      <path
        d="M144 124c-11.04 0-20 8.96-20 20s8.96 20 20 20 20-8.96 20-20-8.96-20-20-20zm-2 35.86c-7.9-.98-14-7.7-14-15.86 0-1.24.16-2.42.42-3.58L138 150v2c0 2.2 1.8 4 4 4zm13.8-5.08c-.52-1.62-2-2.78-3.8-2.78h-2v-6c0-1.1-.9-2-2-2h-12v-4h4c1.1 0 2-.9 2-2v-4h4c2.2 0 4-1.8 4-4v-.82c5.86 2.38 10 8.12 10 14.82 0 4.16-1.6 7.94-4.2 10.78z"
        fill="#fff"
        fill-rule="evenodd"
      />
    </g>
